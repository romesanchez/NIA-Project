      ...
      >
        ...
        <div className="max-w-3xl flex flex-col items-center">
          ...
          <div className="mt-10 flex items-center justify-center gap-4 flex-wrap">
            <button
              onClick={onBrowse}
              className="font-mono text-[12px] tracking-[0.18em] px-6 py-3 bg-gradient-to-r from-primary to-emerald-500 text-primary-foreground hover:brightness-110 transition-all rounded-sm shadow-md shadow-primary/20"
            >
              BROWSE DEPARTMENTS →
            </button>
            <button
