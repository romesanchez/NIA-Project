export type DeviceType =
  ...
  | "WEBCAM" | "LAPTOP" | "SMARTPHONE" | "MEDIACONVERTER" | "CONTROLLER" | "SATELLITE";
...
export interface Department {
  ...
  description: string;
  /**
   * Seed device counts used ONLY to generate the initial topology when
   * localStorage has nothing for this department yet. Once the user places
   * or removes devices on the canvas the live count comes from the topology
   * (via useLiveDevices) — this field is never shown directly in the UI.
   */
